      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Card className="max-w-3xl mx-auto shadow-lg border-border/70">
          ...
          <CardContent className="space-y-4 text-muted-foreground prose prose-sm sm:prose-base dark:prose-invert max-w-none">
            ...
            <p>
              Your privacy is important to us. It is SwiftQR's policy to respect
              your privacy regarding any information we may collect from you
              across our website, swift.no-reply@gmail.com, and other sites we
              own and operate.
            </p>
            ...
            <p>
              ...
              collecting it and how it will be used. The primary data we process
              is the content you provide for QR code generation. This data is
              processed in your browser and is not stored on our servers unless
              explicitly stated for a specific feature (e.g., saved QR codes if
            ...
            <p>
              ...
              time and date of your visit, the time spent on each page, and
              other details for analytical and security purposes. This data is
              used in an aggregated and anonymized manner where possible.
            </p>
            <p>
              <strong>QR Code Data:</strong> The data you enter to generate QR
              codes (URLs, text, contact information, etc.) is processed
              client-side in your browser. We do not store this information on
              our servers by default. If future features allow for saving QR
              codes, you will be informed about how that data is stored.
            </p>
            ...
            <ul className="list-disc list-inside pl-4 space-y-1">
              <li>
                Provide, operate, and maintain our QR code generation services.
              </li>
              <li>
                Improve, personalize, and expand our website and services.
              </li>
              <li>
                Understand and analyze how you use our website to enhance user
                experience.
              </li>
              <li>
              ...
              <li>
                Monitor the usage of our service for security and operational
                stability.
              </li>
            </ul>
            ...
            <p>
              As QR code data is primarily processed client-side, its retention
              is managed by your browser unless specific server-side features
              are used.
            </p>
            ...
            <ul className="list-disc list-inside pl-4 space-y-1">
              ...
              <li>
                Analytics to understand how our website is used (e.g., Google
                Analytics). These cookies may track things such as how long you
                spend on the site and the pages that you visit so we can
            ...
            <p>
              ...
              use commercially acceptable means to protect any personal
              information we might collect (like log data), remember that no
              method of transmission over the Internet, or method of electronic
              storage, is 100% secure. We cannot guarantee its absolute
              security. Data for QR codes is processed in your browser,
              enhancing privacy for that specific data.
            </p>
            ...
            <p>
              ...
              contact us at swift.no-reply@gmail.com.
            </p>
          </CardContent>
        </Card>
      </main>
